...
from pm_core.constants import EXCHANGE_ADDRS
from pm_core.models import NormalizedTrade
from pm_core.token_map import TokenMap

from pm_ingest.normalize.decode import decode_subgraph_event
...
class SubgraphPoller:
    ...
    def __init__(
        ...
        *,
        ...
        # Accept publisher or broker (backward compat)
        self._broker = publisher or broker
