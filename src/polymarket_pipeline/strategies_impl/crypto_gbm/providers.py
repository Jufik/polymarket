...
from polymarket_pipeline.strategies_impl.crypto_gbm.gbm import estimate_rolling_sigma
...
class ExchangePriceProvider:
    ...
    def __init__(
        ...
        **_extra: object,
        ...
        # 1-minute close aggregation for sigma
    ...
    def handle_bar(self, bar: dict[str, Any]) -> None:
        ...
        # Aggregate into 1-minute closes
        minute_ts = ts - (ts % 60)
...
class CryptoWindowProvider:
    ...
    def _rebuild_windows(self, markets_df: Any) -> None:
        ...
        for row in markets_df.iter_rows(named=True):
            ...
            # Keep windows that are active or starting within 5 minutes
        ...
        # Clean up S₀ for expired windows
